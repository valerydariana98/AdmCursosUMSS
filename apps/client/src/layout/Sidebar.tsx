...
const menuItems = [
  ...
  { to: '/cursos', label: 'Cursos', icon: 'document' },
  { to: '/grupos', label: 'Grupos', icon: 'users' },
  { to: '/estudiantes', label: 'Estudiantes', icon: 'user' },
  { to: '/instructores', label: 'Instructores', icon: 'briefcase' },
  { to: '/certificados', label: 'Certificados', icon: 'badge' },
];
